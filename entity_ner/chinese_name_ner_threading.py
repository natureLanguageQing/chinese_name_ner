...
from entity_ner import name_entity
...
list_ner_label(name_entity, "name")
...
if __name__ == '__main__':
    medical_questions = pd.read_csv("../data/name_data_words.csv").drop_duplicates().values.tolist()
    print(medical_questions)
    fp = open('../data/name_data_ner.json', 'w', newline='', encoding='utf-8')
